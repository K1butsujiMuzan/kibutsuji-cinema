...
import {premium} from "@/app/(guest)/welcome/(components)/welcome.data";
...
export default function WelcomePremium() {
  ...
  return (
    <section className={'flex flex-col items-center gap-8 md:gap-14'}>
      <h2 className={'text-2xl md:text-56 font-semibold text-center'}>
        Choose your Premium
      </h2>
      <div className={'flex flex-col gap-6 md:gap-8 items-center w-full'}>
        ...
        <small className={'text-center text-xs max-w-167'}>
